...
| Windows 환경 실행 오류 수정 | 리눅스 전용 폰트 경로 하드코딩으로 인한 FileNotFoundError, statsmodels 미설치 오류를 OS별 분기 처리로 해결 | Windows(py) 환경에서 analysis.py, bonus_decomposition.py, bonus_forecast.py를 재실행해 정상 동작 확인 |
